...
// }
// interface ChartData {
//   day: string;  // The full date in YYYY-MM-DD format
//   activeUsers: number;
...
//   // Modified function to group patients by the actual registration date
//   const groupPatientsByDay = (patients: Patient[]): ChartData[] => {
//     const dayStats: { [key: string]: ChartData } = {};

//     patients.forEach((patient: Patient) => {
//       const registrationDate = patient.date_of_registration
//         ? new Date(patient.date_of_registration)
//         : new Date(); // Fallback to current date if no registration date
//       const dayString = registrationDate.toISOString().split("T")[0]; // Get date in YYYY-MM-DD format

//       if (!dayStats[dayString]) {
//         dayStats[dayString] = {
//           day: dayString,
//           activeUsers: 0,
//           inactiveUsers: 0,
...
//       if (patient.is_new) {
//         dayStats[dayString].newUsers++;
//       }
//       if (patient.is_deleted) {
//         dayStats[dayString].inactiveUsers++;
//       } else {
//         dayStats[dayString].activeUsers++;
//       }
//     });

//     return Object.values(dayStats); // Convert the object to an array
//   };

//   // Use useMemo to memoize the grouped data
...
//                         All
//                       </li>
//                       <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleFilter("activeUsers")}>
//                         Active Users
//                       </li>
//                       <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleFilter("inactiveUsers")}>
//                         Inactive Users
//                       </li>
//                       <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleFilter("newUsers")}>
//                         New Users
//                       </li>
//                     </ul>
//                   </div>
...
// interface ChartData {
//   timeFrame: string; // Change 'day' to 'timeFrame' to accommodate both days and months
//   activeUsers: number;
//   inactiveUsers: number;
// }
...
//     return { dailyStats: dayStats, monthlyStats }; // Return both daily and monthly stats
//   };
...
//     setIsFilterOpen(false);
//     if (filter === "All") {
//       setFilteredData(dailyStats); // Reset to daily stats as default
//     } else if (filter === "activeUsers") {
//       setFilteredData(
...
//                 <Bar dataKey="inactiveUsers" fill="#ffc658" />
//               </BarChart>
//             </ResponsiveContainer>
//           </div>
//         </div>
