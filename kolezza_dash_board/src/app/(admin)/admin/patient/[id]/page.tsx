...
//     active: boolean;
//     payload: { value: number }[];  // Change 'any' to a more specific type
//     label: string;
//   }) => {
//     if (active && payload && payload.length) {
//       const value = payload[0].value;
//       const color = value <= 30 ? "#4CAF50" : value <= 40 ? "#2196F3" : "#F44336";
//       const status = value <= 30 ? "Good" : value <= 40 ? "Better" : "Critical";
...
//   const CustomizedLine = ({ points }: { points: any[] }) => {
//     return (
//       <g>
//         {points.map((point: any, index: number) => {
//           if (index === points.length - 1) return null;
...
//                 {/* Pass CustomTooltip component directly */}
...
//   dataKey="value"
//   stroke="#000"
//   shape={CustomizedLine}  // Pass the function itself, not an element
//   dot={(props) => {
//     const { cx, cy, value } = props;
//     const color =
//       value <= 30
...
//                   dataKey="value"
//                   stroke="#000"
//                   type="monotone" // Specify the line type (use "monotone", "linear", etc.)
//                   dot={(props) => {
//                     const { cx, cy, value } = props;
//                     const color =
//                       value <= 30
